...
The constitutional participation candidate recognizes a project-bound **Founding Sovereign and Constitutional Sponsor** and a governed-system voice in nominations, objections, recusal, dissent, correction, appeal, and removal review. Founding title is not unchecked authority; system preference is not legal personhood or self-appointment; nomination is not approval; approval is not credential binding; and documentation acceptance is not governance activation.
